    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_terms', models.CharField(choices=[('COD', 'Cash on Delivery'), ('CIA', 'Cash in Advance'), ('Net_15', '15 days'), ('Net_30', '30 days')], max_length=30)),
        ...
        migrations.CreateModel(
            name='SparePartWarehouse',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('part_number', models.CharField(max_length=20)),
                ('description', models.CharField(max_length=30)),
                ('quantity', models.IntegerField(null=True, validators=[data.my_validators.quantity_validator])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='car', to='data.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Influencer',
